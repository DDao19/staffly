...
export function Button({
  ...
  const baseClasses = `inline-flex items-center justify-center gap-2 text-sm font-bold py-2 px-4 rounded-lg transition-colors duration-200 cursor-pointer focus:outline-none
